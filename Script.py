...
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/YourDilip'>ᴅɪʟɪᴘ ᴋᴜᴍᴀʀ</a> 
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/YourDilip>☢DILIP☢</a></b>
  
 <b>✯ Join here : <a href=https://t.me/Entertainment_official_channel>☢Join my updateds☢</a></b> 
...
• /plink - <code>Jᴜsᴛ ʟɪᴋᴇ /link, ʙᴜᴛ ᴛʜᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ғᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴ.</code>"""
 ...
 ⚠️ ᴛʜɪꜱ ꜱᴇʀᴠɪᴄᴇ ʜᴀꜱ ʙᴇᴇɴ ꜱᴛᴏᴩᴩᴇᴅ 
    ...
    PROGRESS_BAR = """\n
╭━━━━❰ Entertainment Official Renaming... ❱━➣
┣⪼ 🗂️ : {1} | {2}
┣⪼ ⏳️ : {0}%
┣⪼ 🚀 : {3}/s
┣⪼ ⏱️ : {4}
