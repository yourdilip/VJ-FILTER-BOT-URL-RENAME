...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001231414933'))
...
auth_grp = environ.get('AUTH_GROUP', '-1002091259471') # give your force subscribe group id here else leave it blank
