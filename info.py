...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001967719188,-1002067279882').split()]
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://vj-filter-bot-url-rename-1d09d92fed71.herokuapp.com/")
